...
NETWORKS = (
    ...
    # FLO mainnet : Fprv/Fpub                        176       35        8
    NetworkValues("Florincoin", "mainnet", "FLO", b'\xb0', b'\x23', b'\x08', h2b('01343C31'), h2b('0134406B')),
    # FLO testnet : Fprt/Fput                        239      115      198
    NetworkValues("Florincoin", "testnet", "XFL", b'\xef', b'\x73', b'\xc6', h2b('01343C23'), h2b('013440E2')),
)
